...
public class ImageAdapter extends BaseAdapter {
    ...
    public ImageAdapter(Context c, ArrayList<Wallpaper> mWallpaperList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int height = width* 3/2 + 150;// size.y is the actual height
        ...
        Glide
                ...
                //.thumbnail(0.5f)// for showing the blurred image
                //.transition(withCrossFade())
                //.diskCacheStrategy(DiskCacheStrategy.ALL) // It will cache your image after loaded for first time
                //.override(viewHolder.thumbnail.getWidth(),viewHolder.thumbnail.getHeight()) // Overrides size of downloaded image
