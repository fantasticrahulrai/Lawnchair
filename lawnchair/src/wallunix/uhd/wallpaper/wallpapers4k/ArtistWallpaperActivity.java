...
public class ArtistWallpaperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wallunix_activity_artist_wallpaper);
        ...
        getSupportActionBar().setTitle(artistName+"'s Creations");
        ...
        query.whereEqualTo("artistsid",artistid);
