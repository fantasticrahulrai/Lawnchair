...
public class LockscreenSqlite extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "LockscreenWallpaper";

    // Wallpapers table name
    private static final String TABLE_WALLPAPERS = "Lockscreen";
    ...
    public LockscreenSqlite(Context context) {
