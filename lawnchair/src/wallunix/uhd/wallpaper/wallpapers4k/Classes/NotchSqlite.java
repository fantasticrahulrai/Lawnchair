...
public class NotchSqlite extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "NotchWallpaper";

    // Wallpapers table name
    private static final String TABLE_WALLPAPERS = "Notch";
    ...
    public NotchSqlite(Context context) {
